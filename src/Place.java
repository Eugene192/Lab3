...
public class Place extends AbstractPlace {
    ...
    public  void levelOfWater(Place e, int height){
        if (height == 7 || height == 8 || height == 9){
            System.out.println(super.placeName + " и " + e + " были заполнены водой");
        }
        if (height == 1 || height == 2 || height == 3){
            System.out.println("В " + super.placeName + " и " + e + " не было воды ");
        }
        if (height == 4 || height == 5 || height == 6){
            System.out.println("В " + super.placeName + " и " + e + " было немного воды ");
        }
    }
